...
cmds=[
    ...
    "docker run --rm --name pg-replica-bootstrap -e PGPASSWORD=pgpass -v pgdata-replica:/var/lib/postgresql/data pgvector/pgvector:pg16 pg_basebackup -h 10.10.0.1 -U replicator -D /var/lib/postgresql/data -Fp -Xs -P -R",
