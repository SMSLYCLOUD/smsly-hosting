...
try:
    with transaction.atomic():
        ...
        # Completely force the state to exactly what litellm v1.75 needs
        print("Checking the config again...")
        svc.docker_image = "ghcr.io/berriai/litellm:main-v1.44.0-stable"
        svc.save()
        
        # Older LiteLLM perfectly supports stateless and master key checking.
