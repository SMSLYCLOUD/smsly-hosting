...
@mcp_server.tool()
def list_services(user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_deployment_status(deployment_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_service_logs(service_id: str, lines: int = 50, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_service_env_vars(service_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def set_service_env_var(service_id: str, key: str, value: str, is_secret: bool = False, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def delete_service_env_var(service_id: str, key: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def trigger_service_rebuild(service_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_error_diagnostics(deployment_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def list_projects(user_id: str | None = None, user_email: str | None = None):
    """List all projects/workspaces in the ecosystem."""
    return tools.list_projects(user_id=user_id, user_email=user_email)

@mcp_server.tool()
def get_project_services(project_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def bulk_import_env_vars(service_id: str, env_vars: dict, is_secret: bool = False, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def list_service_addons(service_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def provision_service_addon(service_id: str, addon_type: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_exhaustive_deployment_diagnostics(deployment_id: str, user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def list_managed_servers(user_id: str | None = None, user_email: str | None = None):
...
@mcp_server.tool()
def get_server_health(server_id: str, user_id: str | None = None, user_email: str | None = None):
