...
{_tls_line}
    ...
    # the true client. Without this snippet, Caddy logs/rate-limits see
    # only CF edge IPs — CrowdSec bans single Cloudflare nodes and every
    # client shares one rate-limit bucket. trusted_proxies restricts
