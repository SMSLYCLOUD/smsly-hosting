"""Main provisioning task and cleanup."""
...
def provision_server(self, server_id: str, skip_reboot: bool = False):
    ...
    try:
        ...
        # Track iptables port 5000 rules that _harden_master_firewall added
        try:
...
@shared_task(name="apps.deployments.services.provisioner.cleanup_stale_server_provisioning")
