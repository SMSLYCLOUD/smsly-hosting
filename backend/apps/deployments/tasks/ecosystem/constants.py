...
_DEFAULT_WAVE_RECHECK_SECONDS = 1800
_DEFAULT_MAX_WAVE_WAIT_SECONDS = 7200
# Thirty-minute checks with four checks gives an approximately two-hour
# maximum wait for a previous wave before it is marked timed out.
_WAVE_RECHECK_SECONDS = _DEFAULT_WAVE_RECHECK_SECONDS
_MAX_WAVE_RECHECKS = (
