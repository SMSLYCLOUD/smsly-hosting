...
class BundleViewSet(viewsets.ModelViewSet):
    ...
    def perform_destroy(self, instance):
        ...
        from .tasks_bundles import delete_bundle_task
    ...
    def reprovision(self, request, pk=None):
        ...
        from .tasks_bundles import reprovision_bundle_task
    ...
    def backup(self, request, pk=None):
        ...
        from .tasks_bundles import backup_bundle_component_task
    ...
    def restore(self, request, pk=None):
        ...
        from .tasks_bundles import restore_bundle_component_task
