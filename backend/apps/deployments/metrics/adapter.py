...
class MetricsAdapter:
    ...
    def get_cpu_history(self, service_id: str, duration: str = '1h') -> List[Dict[str, Any]]:
    ...
    def get_memory_history(self, service_id: str, duration: str = '1h') -> List[Dict[str, Any]]:
        return self._generate_mock_data(service_id, 'memory', duration)

    def get_network_history(self, service_id: str, duration: str = '1h') -> List[Dict[str, Any]]:
        return self._generate_mock_data(service_id, 'network', duration)

    def _generate_mock_data(self, service_id: str, metric_type: str, duration: str) -> List[Dict]:
        """
