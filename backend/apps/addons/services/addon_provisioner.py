...
class AddonProvisioner:
    ...
    GENERIC_ADDONS_CONFIG = {
        ...
        'ETCD': {"image": "bitnamilegacy/etcd:3.5.9-debian-11-r99", "port": 2379, "env_url": "ETCD_URL", "auth": False, "env": {"ALLOW_NONE_AUTHENTICATION": "yes"}, "data_dir": "/bitnami/etcd/data"},
