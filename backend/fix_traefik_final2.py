...
"""
    ...
    from apps.deployments.services.local_adapter import LocalDockerAdapter
    adapter = LocalDockerAdapter()
    
    # Traefik will automatically pick up the labels and proxy it!
    # Traefik is running natively on port 80/443 and auto-acquires Let's Encrypt certificates.
