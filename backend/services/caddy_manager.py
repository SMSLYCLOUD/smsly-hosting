    ...
    if use_ssl and domain:
        ...
        platform_block.extend(
            [
                ...
                "    handle @oauth_github {",
                "        rewrite * /accounts/github/login/callback{path}",
                "        reverse_proxy backend:8000",
                "    }",
                "    handle @oauth_google {",
                "        rewrite * /accounts/google/login/callback{path}",
                "        reverse_proxy backend:8000",
                "    }",
                "    handle @oauth_gitlab {",
                "        rewrite * /accounts/gitlab/login/callback{path}",
                "        reverse_proxy backend:8000",
                "    }",
                "    handle @oauth_bitbucket {",
                "        rewrite * /accounts/bitbucket_oauth2/login/callback{path}",
                "        reverse_proxy backend:8000",
                "    }",
                "    handle @oauth_login {",
                "        rewrite * /accounts{path}",
                "        reverse_proxy backend:8000",
                "    }",
                "    handle /auth/* {",
                "        reverse_proxy backend:8000",
