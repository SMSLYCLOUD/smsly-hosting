...
├── scripts/                  # Automation, deployment, and audit scripts
├── infrastructure/           # Docker, Nginx, and Monitoring configs
...
| `RABBITMQ_PASSWORD` | RabbitMQ authentication for Celery broker |
| `REDIS_URL` | Redis connection URI (must include password in production) |
| `CELERY_BROKER_URL` | Celery broker URI (RabbitMQ with auth: `amqp://...`) |
...
- [Developer Guide](docs/DEVELOPER_GUIDE.md) — Architecture, rate limiting, deployment pipeline
- [Frontend Guide](docs/FRONTEND_GUIDE.md) — Next.js architecture, auth flow, components
- [Features Overview](docs/FEATURES.md)
- [Production Deployment](docs/setup/PRODUCTION_DEPLOYMENT.md)
- [Operations Runbook](docs/setup/RUNBOOK.md) — Disaster recovery, monitoring
- [Security Audit](docs/SECURITY_AUDIT.md)
- [Global Deployment](docs/GLOBAL_DEPLOY.md)
- [Infrastructure Audit](docs/reports/INFRASTRUCTURE_AUDIT.md)
