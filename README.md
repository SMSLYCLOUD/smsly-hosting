...
- [Developer Guide](docs/DEVELOPER_GUIDE.md) — Architecture, rate limiting, deployment pipeline, coding conventions
- [Frontend Guide](docs/FRONTEND_GUIDE.md) — Next.js architecture, auth flow, API client, components, hooks
