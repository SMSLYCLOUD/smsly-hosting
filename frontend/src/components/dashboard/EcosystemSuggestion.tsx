...
const suggestionsMap: Record<SuggestionContext, Suggestion> = {
    ...
    services: {
        ...
        description: "Scale smarter. Connect your backend services securely to SMSLY Communication APIs without leaving the private network.",
        icon: Lightbulb,
    ...
    networking: {
        ...
        description: "Enforce zero-trust access. Use SMSLY Identity to wrap your exposed tunnels and dev domains with SilentOTP and Abuse Prevention.",
        icon: Lightbulb,
    ...
    addons: {
        ...
        description: "Your addons run inside the isolated Grid mesh. Connect them securely to your SMSLY Identity layers for compliant, highly-available data isolation.",
        icon: Lightbulb,
    ...
    marketplace: {
        ...
        description: "Grid natively supports 35+ addons, but you can also integrate external services like SMSLY managed email and voice APIs in one click.",
        icon: Lightbulb,
    ...
    settings: {
        ...
        description: "Enable SMSLY Identity audit logs to track every user action, token issuance, and setting change across your ecosystem.",
        icon: Lightbulb,
        color: "text-blue-600 dark:text-blue-400",
        bg: "bg-blue-500/10 border-blue-500/20",
        href: "https://smsly.cloud",
    ...
    general: {
        title: "Platform Tip",
        description: "Grid connects seamlessly with the full SMSLY Cloud ecosystem for identity, communications, and intelligence.",
        icon: Lightbulb,
