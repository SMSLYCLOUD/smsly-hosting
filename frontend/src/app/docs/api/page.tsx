  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2.5 bg-orange-100 dark:bg-orange-900/50 rounded-xl">
              <Code2 className="w-6 h-6 text-orange-700 dark:text-orange-300" />
            </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-slate dark:prose-invert">
        ...
        <div className="not-prose my-8 p-8 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-center">
          <Code2 size={32} className="mx-auto text-slate-400 mb-3" />
