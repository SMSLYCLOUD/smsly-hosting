...
Internal network (Docker, encrypted WireGuard mesh):
  ...
  └─ Socket Proxy — filtered Docker API access`}
        ...
        <p>
          If you discover a security vulnerability in Grid, please report it responsibly. Do not open a public GitHub issue for security vulnerabilities. Instead, email <a href="mailto:security@smsly.cloud">security@smsly.cloud</a> with:
        </p>
