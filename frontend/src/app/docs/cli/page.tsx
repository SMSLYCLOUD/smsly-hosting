  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-slate dark:prose-invert prose-headings:scroll-mt-24">
        ...
        <h2>Commands</h2>
        <ul>
          <li><code>cn login</code> &mdash; Authenticate with your Grid instance</li>
          <li><code>cn deploy</code> &mdash; Deploy the current directory</li>
          <li><code>cn logs</code> &mdash; View runtime logs for a service</li>
          <li><code>cn ssh</code> &mdash; SSH into a running container</li>
        </ul>
