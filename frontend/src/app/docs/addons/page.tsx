        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2.5 bg-rose-100 dark:bg-rose-900/50 rounded-xl">
              <Puzzle className="w-6 h-6 text-rose-700 dark:text-rose-300" />
            </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mb-12">
          {addons.map(addon => {
            ...
            return (
              <div key={addon.name} className={`p-5 rounded-xl border border-slate-200 dark:border-slate-700 ${addon.bg}`}>
        ...
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Provisioning</h2>
        ...
        <div className="not-prose p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700">
