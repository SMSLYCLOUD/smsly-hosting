  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-slate dark:prose-invert prose-headings:scroll-mt-24">
        ...
        <p>
          By accessing or using Grid (&quot;the Service&quot;), operated by SMSLYCLOUD (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, do not use the Service.
        </p>
        <p>
        ...
        <p>
          Grid is released under the MIT License. You are free to use, modify, and distribute the software in accordance with the license terms. The open-source nature of Grid does not alter these Terms for the hosted Service provided by SMSLYCLOUD.
        </p>
        ...
        <p>
          The Service, including its design, code, features, and documentation, is owned by SMSLYCLOUD and protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or reverse-engineer any part of the Service except as permitted by the open-source license.
        </p>

        <h2>10. Limitation of Liability</h2>
        <p>
          To the maximum extent permitted by law, SMSLYCLOUD and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:
        </p>
        <ul>
        ...
        <p>
          You agree to indemnify, defend, and hold harmless SMSLYCLOUD and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
        </p>
        <ul>
        ...
        <p>
          These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which SMSLYCLOUD operates, without regard to its conflict of law provisions. Any disputes shall be resolved in the courts of competent jurisdiction in that jurisdiction.
        </p>
        ...
        <h2>17. Contact</h2>
        <p>
          If you have questions about these Terms, please contact us at <a href="mailto:legal@smsly.cloud">legal@smsly.cloud</a> or visit our <Link href="https://github.com/SMSLYCLOUD/smsly-hosting">GitHub repository</Link>.
        </p>
      </div>
    </main>
  );
