...
- Before wiping/reinstalling a VPS or server, review and push all uncommitted code to remote — ensures no local-only changes are lost during a destructive operation. Confidence: 0.65
